...
namespace TicketToRide.Model.Players
{
    public class SimpleStrategyBot : BotPlayer
    {
        ...
        public override Move GetNextMove(Game game, PossibleMoves possibleMoves)
        {
            ...
            var shortestPathRoutes = GameRouteGraph.FindAllShortestPathsBetweenDestinationCards(PendingDestinationCards, Color, game.Players.Count);
        ...
        protected DestinationCard GetBestDestinationCard(List<DestinationCard> destinationCards, Game game)
        {
            ...
            {
                var shortestPathRoutes = GameRouteGraph.FindAllShortestPathsBetweenDestinationCards(new List<DestinationCard> { card }, Color,  game.Players.Count);
